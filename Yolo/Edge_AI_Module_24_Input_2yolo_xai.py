...
Edge_non_QClassifier = 'models/FireResNet50-100PKQ.pt' 
Edge_Classifier = 'models/FireResNet50-100PK.pt'                # Compressed Model for Classification
    ...
    for video_to_test in videos_to_test:
        ...
        while cam.isOpened():
            ...
            if predicted_class == 0 or predicted_class == 2:
                ...
                cv2.imshow('Grad-CAM', cv2.resize(overlayed_img, (640, 480)))

                # Display the class label
                cv2.putText(overlayed_img, fire_classes[predicted_class], (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0), 3)
                ...
                fps = int(fps)
                average_fps.append(fps)
                cv2.putText(overlayed_img, "FPS: " + str(fps), (500, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
...
def main():
    ...
    but2 = Button(
        ...
        fg="black",
        relief=RAISED,
        command=lambda: XAI(Base_Classifier),
        text="XAI",
        font=("helvetica 16 bold"),
    )
    ...
    but3 = Button(
        ...
        fg="black",
        relief=RAISED,
        command=lambda: fire_detection(Edge_non_QClassifier, Base_Detector, Yolo_Detector),
        text="Fire detection",
        font=("helvetica 16 bold"),
    )
    ...
    but4 = Button(
        ...
        fg="black",
        relief=RAISED,
        command=lambda: XAI(Edge_Classifier),
        text="XAI",
        font=("helvetica 16 bold"),
    )
